...
import {Input, Button, Typography, Card, Box, Modal, ModalDialog, FormHelperText} from '@mui/joy';
        ...
        <form onSubmit={formik.handleSubmit}>
            ...
            >
                ...
                >
                    ...
                    <FormControl>
                      <FormLabel sx={{fontSize: '1rem'}}>Username</FormLabel>
                        <Input
                            id="username"
                            name="username"
                            label="Username"
                    ...
                    <FormControl>
                        <FormLabel sx={{fontSize: '1rem'}}>Password</FormLabel>
                        <Input
                            id="password"
                            name="password"
                            label="Password"
                    ...
                    <Box p='7px' sx={{ display: 'flex', justifyContent: 'center' }}> {/* Added */}
                        <GoogleLogin
